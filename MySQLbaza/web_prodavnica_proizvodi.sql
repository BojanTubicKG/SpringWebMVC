...
CREATE TABLE `proizvodi` (
  ...
  `grupa_proizvoda` varchar(45) NOT NULL,
...
INSERT INTO `proizvodi` VALUES (4,'Cokolada','Milka',45,'120.00 RSD'),(5,'Cokolada','Kinder',47,'150.00 RSD'),(6,'Vino','Vranac',50,'350.00 RSD'),(7,'Kafa','Grand',50,'120.00 RSD'),(8,'Vino','Shardone',150,'500.00 RSD');
