<%-- 
    Document   : azuriraj_proizvod
    Created on : May 11, 2016, 11:02:10 AM
    Author     : User
--%>
...
<html>
    ...
    <body style="background-color: dimgrey;">
        ...
        <h2>Azuriraj proizvod :</h2>
            <form:form action="azuriraj_proizvod.htm" method="post" commandName="proizvodi1">
                <div>
                <form:label path="proizvodi_id">ID proizvoda za izmenu :</form:label><br>
